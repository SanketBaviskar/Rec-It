...
import MemberTypeForm, { formSchema } from "./MemberTypeForm";
...
export default function MemberTypes({ onComplete }: MemberTypesProps = {}) {
	const [memberTypes, setMemberTypes] =
		useState<MemberType[]>(initialMemberTypes);
	...
	const handleDelete = (id: string) => {
		if (
			window.confirm("Are you sure you want to delete this member type?")
		) {
					...
					<DialogContent className="sm:max-w-[600px]">
						...
						<MemberTypeForm
							initialData={
								editingMemberType
									? {
											name: editingMemberType.name,
											description:
												editingMemberType.description,
											accessLevel:
												editingMemberType.accessLevel,
											dateCreated:
												editingMemberType.dateCreated,
									  }
									: undefined
							}
								...
								<TableCell>
									<span
										className={`px-2 py-1 text-xs rounded-full ${
											memberType.accessLevel === "Premium"
